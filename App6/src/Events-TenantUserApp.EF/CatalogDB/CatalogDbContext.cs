...
namespace Events_TenantUserApp.EF.CatalogDB
{
    ...
    {
        public virtual DbSet<Tenants> Tenants => Set<Tenants>();
        public virtual DbSet<Databases> Databases => Set<Databases>();
        public virtual DbSet<ElasticPools> ElasticPools => Set<ElasticPools>();
        public virtual DbSet<Servers> Servers => Set<Servers>();
