...
namespace Events_TenantUserApp.EF.TenantsDB
{
    ...
    {
        public virtual DbSet<Countries> Countries => Set<Countries>();
        public virtual DbSet<Customers> Customers => Set<Customers>();
        public virtual DbSet<EventSections> EventSections => Set<EventSections>();
        public virtual DbSet<Events> Events => Set<Events>();
        public virtual DbSet<Sections> Sections => Set<Sections>();
        public virtual DbSet<TicketPurchases> TicketPurchases => Set<TicketPurchases>();
        public virtual DbSet<Tickets> Tickets => Set<Tickets>();
        public virtual DbSet<Venue> Venue => Set<Venue>();
        public virtual DbSet<VenueTypes> VenueTypes => Set<VenueTypes>();
        public virtual DbSet<EventsWithNoTicket> EventsWithNoTicket => Set<EventsWithNoTicket>();
        public virtual DbSet<DatabaseFirewallRules> DatabaseFirewallRules => Set<DatabaseFirewallRules>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Countries>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.CountryCode, e.Language })
                    .HasDatabaseName("IX_Countries_Country_Language")
                    .IsUnique();
            ...
            modelBuilder.Entity<VenueTypes>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.VenueTypeName, e.Language })
                    .HasDatabaseName("IX_VENUETYPES_VENUETYPENAME_LANGUAGE")
                    .IsUnique();
            ...
            modelBuilder.Entity<DatabaseFirewallRules>()
                .Property(e => e.StartIpAddress)
                .IsUnicode(false);

            modelBuilder.Entity<DatabaseFirewallRules>()
                .Property(e => e.EndIpAddress)
                .IsUnicode(false);
        }
    }
}